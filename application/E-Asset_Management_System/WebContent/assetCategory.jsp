                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form action="addAssetCategory" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input  type="text" name="lendingPeriod" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Lending Period">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="lateReturnFee" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Late Return Fee ">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="daysBanned" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
