                                    ...
                                    <form action="registerUser" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp" name="uname"
                                        ...
                                        <div class="form-group">
                                            <input input type="text" name="userName" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp" name="uname"
                                        ...
                                        <button   tyep="submit">Register</button>
                                       
                                        <hr>

                                    <div class="text-center">
                                        <a class="btn btn-primary btn-user btn-block" href="register.jsp">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
